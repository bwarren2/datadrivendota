...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TeamDossier.update_time'
        db.add_column(u'teams_teamdossier', 'update_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TeamDossier.update_time'
        db.delete_column(u'teams_teamdossier', 'update_time')
