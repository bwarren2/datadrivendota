...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TeamDossier.logo_url'
        db.alter_column(u'teams_teamdossier', 'logo_url', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'TeamDossier.logo_sponsor_url'
        db.alter_column(u'teams_teamdossier', 'logo_sponsor_url', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'TeamDossier.logo_url'
        db.alter_column(u'teams_teamdossier', 'logo_url', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'TeamDossier.logo_sponsor_url'
        db.alter_column(u'teams_teamdossier', 'logo_sponsor_url', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
    ...
    models = {
        ...
        u'teams.teamdossier': {
            ...
            'logo_sponsor_url': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True'}),
            'logo_url': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True'}),
