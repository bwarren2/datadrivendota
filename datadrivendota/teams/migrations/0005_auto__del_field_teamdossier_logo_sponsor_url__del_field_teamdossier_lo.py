...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TeamDossier.logo_sponsor_url'
        db.delete_column(u'teams_teamdossier', 'logo_sponsor_url')

        # Deleting field 'TeamDossier.logo_url'
        db.delete_column(u'teams_teamdossier', 'logo_url')

        # Adding field 'TeamDossier.logo_image'
        db.add_column(u'teams_teamdossier', 'logo_image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True),
                      keep_default=False)

        # Adding field 'TeamDossier.logo_sponsor_image'
        db.add_column(u'teams_teamdossier', 'logo_sponsor_image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TeamDossier.logo_sponsor_url'
        db.add_column(u'teams_teamdossier', 'logo_sponsor_url',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True),
                      keep_default=False)

        # Adding field 'TeamDossier.logo_url'
        db.add_column(u'teams_teamdossier', 'logo_url',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True),
                      keep_default=False)

        # Deleting field 'TeamDossier.logo_image'
        db.delete_column(u'teams_teamdossier', 'logo_image')

        # Deleting field 'TeamDossier.logo_sponsor_image'
        db.delete_column(u'teams_teamdossier', 'logo_sponsor_image')
