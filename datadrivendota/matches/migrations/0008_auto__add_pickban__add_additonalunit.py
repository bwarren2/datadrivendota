...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PickBan'
        db.create_table(u'matches_pickban', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('match', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['matches.Match'], unique=True)),
        ...
        db.send_create_signal(u'matches', ['PickBan'])
    ...
    def backwards(self, orm):
        # Deleting model 'PickBan'
        db.delete_table(u'matches_pickban')
