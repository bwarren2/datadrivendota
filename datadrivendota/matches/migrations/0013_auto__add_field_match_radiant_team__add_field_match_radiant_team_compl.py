...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Match.radiant_team'
        db.add_column(u'matches_match', 'radiant_team',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='radiant_guild', null=True, to=orm['teams.Team']),
                      keep_default=False)

        # Adding field 'Match.radiant_team_complete'
        db.add_column(u'matches_match', 'radiant_team_complete',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Match.dire_team'
        db.add_column(u'matches_match', 'dire_team',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='dire_team', null=True, to=orm['teams.Team']),
                      keep_default=False)

        # Adding field 'Match.dire_team_complete'
        db.add_column(u'matches_match', 'dire_team_complete',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Match.radiant_team'
        db.delete_column(u'matches_match', 'radiant_team_id')

        # Deleting field 'Match.radiant_team_complete'
        db.delete_column(u'matches_match', 'radiant_team_complete')

        # Deleting field 'Match.dire_team'
        db.delete_column(u'matches_match', 'dire_team_id')

        # Deleting field 'Match.dire_team_complete'
        db.delete_column(u'matches_match', 'dire_team_complete')
    ...
    models = {
        ...
        u'matches.match': {
            ...
            'dire_team_complete': ('django.db.models.fields.BooleanField', [], {}),
            ...
            'radiant_team_complete': ('django.db.models.fields.BooleanField', [], {}),
