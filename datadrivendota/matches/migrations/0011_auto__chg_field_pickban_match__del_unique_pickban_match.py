...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'PickBan', fields ['match']
        db.delete_unique(u'matches_pickban', ['match_id'])


        # Changing field 'PickBan.match'
        db.alter_column(u'matches_pickban', 'match_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['matches.Match']))

    def backwards(self, orm):

        # Changing field 'PickBan.match'
        db.alter_column(u'matches_pickban', 'match_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['matches.Match'], unique=True))
        # Adding unique constraint on 'PickBan', fields ['match']
        db.create_unique(u'matches_pickban', ['match_id'])
