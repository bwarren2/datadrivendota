...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Match.dire_guild'
        db.add_column(u'matches_match', 'dire_guild',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='dire_guild', null=True, to=orm['guilds.Guild']),
                      keep_default=False)

        # Adding field 'Match.radiant_guild'
        db.add_column(u'matches_match', 'radiant_guild',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='radiant_guild', null=True, to=orm['guilds.Guild']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Match.dire_guild'
        db.delete_column(u'matches_match', 'dire_guild_id')

        # Deleting field 'Match.radiant_guild'
        db.delete_column(u'matches_match', 'radiant_guild_id')
    ...
    models = {
        ...
        u'matches.additonalunit': {
            'Meta': {'object_name': 'AdditonalUnit'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
