...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PlayerMatchSummary.match'
        db.add_column(u'matches_playermatchsummary', 'match',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['matches.Match']),
                      keep_default=False)

        # Deleting field 'SkillBuild.match_id'
        db.delete_column(u'matches_skillbuild', 'match_id_id')

        # Adding field 'SkillBuild.player_match_summary'
        db.add_column(u'matches_skillbuild', 'player_match_summary',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['matches.PlayerMatchSummary']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PlayerMatchSummary.match'
        db.delete_column(u'matches_playermatchsummary', 'match_id')

        # Adding field 'SkillBuild.match_id'
        db.add_column(u'matches_skillbuild', 'match_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['matches.PlayerMatchSummary']),
                      keep_default=False)

        # Deleting field 'SkillBuild.player_match_summary'
        db.delete_column(u'matches_skillbuild', 'player_match_summary_id')
