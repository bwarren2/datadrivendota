...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Match.radiant_team_complete'
        db.alter_column(u'matches_match', 'radiant_team_complete', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Match.dire_team_complete'
        db.alter_column(u'matches_match', 'dire_team_complete', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Match.radiant_team_complete'
        raise RuntimeError("Cannot reverse this migration. 'Match.radiant_team_complete' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Match.radiant_team_complete'
        db.alter_column(u'matches_match', 'radiant_team_complete', self.gf('django.db.models.fields.BooleanField')())

        # User chose to not deal with backwards NULL issues for 'Match.dire_team_complete'
        raise RuntimeError("Cannot reverse this migration. 'Match.dire_team_complete' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Match.dire_team_complete'
        db.alter_column(u'matches_match', 'dire_team_complete', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        u'matches.match': {
            ...
            'dire_team': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'dire_team'", 'null': 'True', 'to': u"orm['teams.Team']"}),
            'dire_team_complete': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'radiant_team': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'radiant_guild'", 'null': 'True', 'to': u"orm['teams.Team']"}),
            'radiant_team_complete': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'radiant_win': ('django.db.models.fields.BooleanField', [], {}),
            'series_id': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'series_type': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
