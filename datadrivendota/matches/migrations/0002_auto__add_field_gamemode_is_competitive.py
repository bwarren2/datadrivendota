...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GameMode.is_competitive'
        db.add_column(u'matches_gamemode', 'is_competitive',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GameMode.is_competitive'
        db.delete_column(u'matches_gamemode', 'is_competitive')
