...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'matches_scheduledmatch', (
        ...
        db.send_create_signal(u'matches', ['ScheduledMatch'])


    def backwards(self, orm):
        # Deleting model 'ScheduledMatch'
        db.delete_table(u'matches_scheduledmatch')
    ...
    models = {
        ...
        u'heroes.hero': {
            ...
            'machine_name': ('django.db.models.fields.SlugField', [], {'max_length': '200', 'unique': 'True', 'null': 'True'}),
        ...
        u'matches.match': {
            ...
            'radiant_team': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'radiant_team'", 'null': 'True', 'to': u"orm['teams.Team']"}),
            ...
            'replay': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True'}),
