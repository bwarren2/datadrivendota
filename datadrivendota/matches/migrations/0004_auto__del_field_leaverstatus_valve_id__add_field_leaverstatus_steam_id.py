...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LeaverStatus.valve_id'
        db.delete_column(u'matches_leaverstatus', 'valve_id')

        # Adding field 'LeaverStatus.steam_id'
        db.add_column(u'matches_leaverstatus', 'steam_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'LobbyType.valve_id'
        db.delete_column(u'matches_lobbytype', 'valve_id')

        # Adding field 'LobbyType.steam_id'
        db.add_column(u'matches_lobbytype', 'steam_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'GameMode.valve_id'
        db.delete_column(u'matches_gamemode', 'valve_id')

        # Adding field 'GameMode.steam_id'
        db.add_column(u'matches_gamemode', 'steam_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'LeaverStatus.valve_id'
        db.add_column(u'matches_leaverstatus', 'valve_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'LeaverStatus.steam_id'
        db.delete_column(u'matches_leaverstatus', 'steam_id')

        # Adding field 'LobbyType.valve_id'
        db.add_column(u'matches_lobbytype', 'valve_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'LobbyType.steam_id'
        db.delete_column(u'matches_lobbytype', 'steam_id')

        # Adding field 'GameMode.valve_id'
        db.add_column(u'matches_gamemode', 'valve_id',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'GameMode.steam_id'
        db.delete_column(u'matches_gamemode', 'steam_id')
