...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Match.match_validity'
        db.delete_column(u'matches_match', 'match_validity')

        # Adding field 'Match.validity'
        db.add_column(u'matches_match', 'validity',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Match.match_validity'
        db.add_column(u'matches_match', 'match_validity',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Match.validity'
        db.delete_column(u'matches_match', 'validity')
