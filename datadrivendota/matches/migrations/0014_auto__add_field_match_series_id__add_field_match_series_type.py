...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Match.series_id'
        db.add_column(u'matches_match', 'series_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Match.series_type'
        db.add_column(u'matches_match', 'series_type',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Match.series_id'
        db.delete_column(u'matches_match', 'series_id')

        # Deleting field 'Match.series_type'
        db.delete_column(u'matches_match', 'series_type')
