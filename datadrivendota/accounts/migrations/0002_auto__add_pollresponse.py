...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_pollresponse', (
        ...
        db.send_create_signal(u'accounts', ['PollResponse'])


    def backwards(self, orm):
        # Deleting model 'PollResponse'
        db.delete_table(u'accounts_pollresponse')
    ...
    models = {
        ...
        u'accounts.permissioncode': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'0ffbcb74-cc77-4588-ba1e-3df5f53bd342'", 'max_length': '40'}),
