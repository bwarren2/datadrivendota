...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PollResponse.steam_id'
        db.alter_column(u'accounts_pollresponse', 'steam_id', self.gf('django.db.models.fields.BigIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'PollResponse.steam_id'
        db.alter_column(u'accounts_pollresponse', 'steam_id', self.gf('django.db.models.fields.BigIntegerField')(default=0))
    ...
    models = {
        ...
        u'accounts.permissioncode': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'8a5eda1c-e5be-4e82-8611-1f29d00c2a13'", 'max_length': '40'}),
        ...
        u'accounts.pollresponse': {
            'Meta': {'object_name': 'PollResponse'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'interested_in_premium': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'steam_id': ('django.db.models.fields.BigIntegerField', [], {'null': 'True', 'blank': 'True'})
        },
