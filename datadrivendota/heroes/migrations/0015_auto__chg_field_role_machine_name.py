...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Role.machine_name'
        db.alter_column(u'heroes_role', 'machine_name', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

    def backwards(self, orm):

        # Changing field 'Role.machine_name'
        db.alter_column(u'heroes_role', 'machine_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
