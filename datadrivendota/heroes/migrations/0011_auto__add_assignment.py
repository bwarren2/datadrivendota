...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'heroes_assignment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('hero', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['heroes.Hero'])),
            ('role', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['heroes.Role'])),
            ('magnitude', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'heroes', ['Assignment'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'heroes_assignment')
