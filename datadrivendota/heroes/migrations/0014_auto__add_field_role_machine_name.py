...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Role.machine_name'
        db.add_column(u'heroes_role', 'machine_name',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Role.machine_name'
        db.delete_column(u'heroes_role', 'machine_name')
    ...
    models = {
        ...
        u'heroes.role': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'machine_name': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True'}),
