...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'heroes_hero', 'machine_name', self.gf('django.db.models.fields.SlugField')(max_length=200, unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'Hero.machine_name'
        db.alter_column(u'heroes_hero', 'machine_name', self.gf('django.db.models.fields.SlugField')(default='', max_length=200, unique=True))
    ...
    models = {
        ...
        u'heroes.hero': {
            ...
            'machine_name': ('django.db.models.fields.SlugField', [], {'default': 'None', 'max_length': '200', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'mugshot': ('django.db.models.fields.files.ImageField', [], {'default': "'blank_hero_mugshot.png'", 'max_length': '100', 'null': 'True'}),
            ...
            'thumbshot': ('django.db.models.fields.files.ImageField', [], {'default': "'blank_hero_thumb.png'", 'max_length': '100', 'null': 'True'}),
