...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Hero', fields ['steam_id']
        db.create_unique(u'heroes_hero', ['steam_id'])

        # Adding unique constraint on 'Ability', fields ['steam_id']
        db.create_unique(u'heroes_ability', ['steam_id'])

        # Adding unique constraint on 'Role', fields ['name']
        db.create_unique(u'heroes_role', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Role', fields ['name']
        db.delete_unique(u'heroes_role', ['name'])

        # Removing unique constraint on 'Ability', fields ['steam_id']
        db.delete_unique(u'heroes_ability', ['steam_id'])

        # Removing unique constraint on 'Hero', fields ['steam_id']
        db.delete_unique(u'heroes_hero', ['steam_id'])
