...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Hero.machine_name'
        raise RuntimeError("Cannot reverse this migration. 'Hero.machine_name' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Hero.machine_name'
        db.alter_column(u'heroes_hero', 'machine_name', self.gf('django.db.models.fields.SlugField')(max_length=200, unique=True))
