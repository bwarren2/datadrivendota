...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Hero', fields ['machine_name']
        db.delete_unique(u'heroes_hero', ['machine_name'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Hero.machine_name'
        db.alter_column(u'heroes_hero', 'machine_name', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=200, null=True))
        # Adding unique constraint on 'Hero', fields ['machine_name']
        db.create_unique(u'heroes_hero', ['machine_name'])
