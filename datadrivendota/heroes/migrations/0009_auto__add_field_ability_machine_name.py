...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ability.machine_name'
        db.add_column(u'heroes_ability', 'machine_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=150),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ability.machine_name'
        db.delete_column(u'heroes_ability', 'machine_name')
