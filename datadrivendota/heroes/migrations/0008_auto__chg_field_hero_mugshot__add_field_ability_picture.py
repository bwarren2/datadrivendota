...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Ability.picture'
        db.add_column(u'heroes_ability', 'picture',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Hero.mugshot'
        db.alter_column(u'heroes_hero', 'mugshot', self.gf('django.db.models.fields.files.ImageField')(max_length=150, null=True))
        # Deleting field 'Ability.picture'
        db.delete_column(u'heroes_ability', 'picture')
