...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Ability', fields ['machine_name']
        db.create_unique(u'heroes_ability', ['machine_name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Ability', fields ['machine_name']
        db.delete_unique(u'heroes_ability', ['machine_name'])
    ...
    models = {
        u'heroes.ability': {
            ...
            'is_ultimate': ('django.db.models.fields.BooleanField', [], {}),
