...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Applicant.interested_in_premium'
        db.add_column(u'players_applicant', 'interested_in_premium',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Applicant.interested_in_premium'
        db.delete_column(u'players_applicant', 'interested_in_premium')
    ...
    models = {
        ...
        u'players.permissioncode': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'29721447-c1b8-4e2d-ad7e-83a5166e20c4'", 'max_length': '40'}),
