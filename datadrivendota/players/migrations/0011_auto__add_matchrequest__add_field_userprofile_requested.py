...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'players_matchrequest', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('match_id', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'players', ['MatchRequest'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'players_matchrequest')
    ...
    models = {
        ...
        u'players.permissioncode': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'ef511dac-8dce-4538-ac83-2b237b879929'", 'max_length': '40'}),
        ...
        u'players.userprofile': {
            ...
            'requested': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['players.MatchRequest']", 'null': 'True'}),
            'track_limit': ('django.db.models.fields.IntegerField', [], {'default': '10'}),
