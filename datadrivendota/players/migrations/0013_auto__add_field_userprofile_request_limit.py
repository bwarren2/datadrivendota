...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.request_limit'
        db.add_column(u'players_userprofile', 'request_limit',
                      self.gf('django.db.models.fields.IntegerField')(default=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.request_limit'
        db.delete_column(u'players_userprofile', 'request_limit')
    ...
    models = {
        ...
        u'players.permissioncode': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'304aac20-7d90-4ee8-a6b4-684b38f554a9'", 'max_length': '40'}),
