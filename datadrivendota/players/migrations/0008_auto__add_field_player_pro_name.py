...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Player.pro_name'
        db.add_column(u'players_player', 'pro_name',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Player.pro_name'
        db.delete_column(u'players_player', 'pro_name')
    ...
    models = {
        ...
        u'players.permissioncode': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'30dd836a-ec87-4b16-9a02-2f3d0c1b3a22'", 'max_length': '40'}),
