...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'MatchRequest', fields ['match_id']
        db.create_unique(u'players_matchrequest', ['match_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'MatchRequest', fields ['match_id']
        db.delete_unique(u'players_matchrequest', ['match_id'])
    ...
    models = {
        ...
        u'players.permissioncode': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'06168d6c-7058-40b6-a008-96c500a13ac9'", 'max_length': '40'}),
