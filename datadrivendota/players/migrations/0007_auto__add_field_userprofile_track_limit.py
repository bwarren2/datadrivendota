...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.track_limit'
        db.add_column(u'players_userprofile', 'track_limit',
                      self.gf('django.db.models.fields.IntegerField')(default=7),
                      keep_default=False)

        # Adding M2M table for field tracking on 'UserProfile'
        db.create_table(u'players_userprofile_tracking', (
        ...
        db.create_unique(u'players_userprofile_tracking', ['userprofile_id', 'player_id'])


    def backwards(self, orm):
        # Deleting field 'UserProfile.track_limit'
        db.delete_column(u'players_userprofile', 'track_limit')

        # Removing M2M table for field tracking on 'UserProfile'
        db.delete_table('players_userprofile_tracking')
    ...
    models = {
        ...
        u'players.permissioncode': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'9cc8e119-b543-4296-aed2-eaf6da2d679e'", 'max_length': '40'}),
